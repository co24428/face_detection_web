...
@Component({
  selector: 'app-detect-face-yolov8s',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './detect-face-yolov8s.component.html',
  styleUrl: './detect-face-yolov8s.component.css'
})
export class DetectFaceYolov8sComponent  implements OnDestroy {
  ...
  private modelPath = '/assets/yolov8s-face-lindevs.onnx';
